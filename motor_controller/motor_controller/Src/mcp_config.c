...
static uint8_t MCPSyncTxBuff[MCP_TX_SYNCBUFFER_SIZE]
    __attribute__((aligned(4))); // cstat !MISRAC2012-Rule-1.4_a
...
static uint8_t
    dataSizeTableBuffA[MCPA_OVER_UARTA_STREAM]; /* buffered version of
                                                   dataSizeTableA */
...
MCP_Handle_t MCP_Over_UartA = {
    .pTransportLayer =
        (MCTL_Handle_t *)&aspepOverUartA, // cstat !MISRAC2012-Rule-11.3
};
